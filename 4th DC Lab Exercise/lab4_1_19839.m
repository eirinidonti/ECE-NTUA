...
clear all; %16-ASK
k = 4; L=2^k; nsamp = 16; EbNo = 10; Nsymb = 10000; step=2;
...
rolloff = 0.35; % Συντελεστής πτώσης -- rolloff factor
...
%%
%a.
figure; stem(yrx(1:10*nsamp));
%b.
figure; stem([1:nsamp:nsamp*10],y1(1:10),'filled');
%c.
figure; pwelch(yrx,[],[],[],1);
end