# Digital Business Management 2022-2023
...
- _Exercise on DISCO_: Exercise using DISCO (process mining software), which analyzes real process data, applies process mining techniques, and gains insights into process efficiency, bottlenecks, and potential improvements within an organization. [![Disco](https://img.shields.io/badge/-Disco-%238A2BE2?logo=disco&logoColor=white)](https://fluxicon.com/disco/)
